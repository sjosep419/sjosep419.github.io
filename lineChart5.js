...
function LineChart2018(data, {
    ...
    const svg = d3.select("#chart2018") // div in the index.html
  ...
  function LineChart2020(data, {
    ...
    // Create a svg with dimension constrains.
    const svg = d3.select("#chart2020") // div in the index.html
        .append("svg") // append the graph to the svg element of the div
        .attr("width", width)
        .attr("height", height)
        .attr("viewBox", [0, 0, width, height])
